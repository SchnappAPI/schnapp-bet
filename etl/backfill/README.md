...
One-time backfill scripts for MLB, NBA, and NFL historical data stored as Parquet in blob storage (`schnappmlbdata` storage account).
...
```
STORAGE_ACCOUNT=schnappmlbdata
STORAGE_KEY=<key>
STORAGE_CONTAINER=<mlb-backfill|nba-backfill|nfl-backfill>
