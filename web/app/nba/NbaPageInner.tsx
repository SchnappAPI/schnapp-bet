    ...
    <div className="flex flex-col min-h-screen">
      <div className="px-4 py-3 border-b border-border flex items-center justify-end gap-3">
        ...
        <div className="flex items-center gap-3">
          <Link
            href={gradesHref}
            className="text-sm font-medium text-fg-subtle hover:text-brand transition-colors"
          >
            At a Glance
          </Link>
          {!isDemo && (
      ...
      {loading && <div className="px-4 py-3 text-sm text-fg-subtle">{loadingWord}...</div>}
      ...
      <div className="flex-1 px-4">
        {activeGame ? (
          ...
          !loading && games.length === 0 && (
            <div className="py-6 text-sm text-fg-subtle">No games scheduled for this date.</div>
          )
        )}
