 ...
 *
 * isAdmin: boolean
 *   True when localStorage.schnapp_admin_token is set (i.e., the user has
 *   successfully logged into /admin on this device). Purely a UX hint that
 *   surfaces the Admin link in the sidebar; /admin enforces its own
 *   server-side ADMIN_PASSCODE gate regardless.
 *
